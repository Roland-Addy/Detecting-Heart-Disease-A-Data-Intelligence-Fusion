...
This project seeks to apply machine learning techniques on a 2022 annual CDC survey data, of 400k+ adults related to their health status, to predict an individual's propensity to a heart attack. The ultimate goal of this project is to apply several machine learning methods, especially classifier models (logistic regression, SVM, random forest, etc.) to help make predictions of heart attacks.
...
| SleepHours	                             | On average, how many hours of sleep do you get in 24 hours?          |
...
| ECigaretteUsage	                         | Would you say you have never used e-cigarettes or other electronic vaping products in your entire life or now use them every day, use them some days, or use them in the past but do not currently use them at all?| 
...
| FluVaxLast12                             | During the past 12 months, have you had either a flu vaccine that was sprayed in your nose or a flu shot injected into your arm?         | 
...
| CovidPos                                 | Has a doctor, nurse, or anotther health professional ever told you that you tested positive for COVID-19?        |
...
Notably, the below are significant in determining an individual’s odds of having a heart attack:
* The sex
...
* The dataset was split into train and test sets. The train set was upsampled to resolve the class imbalance.
...
* * Logistic Regression - AUC Score of 0.878
  * Decision Tree Classifier - AUC Test Score of 0.665
  * Naives Bayes Classification - AUC Test Score of 0.815
  * Random Forest Classifier - AUC Test Score of 0.852
